...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case mSHARES:
            return QString("mSHARES");
        case uSHARES:
            return QString::fromUtf8("μSHARES");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case SHARES:
            return QString("tSHARES");
        case mSHARES:
            return QString("mtSHARES");
        case uSHARES:
            return QString::fromUtf8("μtSHARES");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case SHARES:
            return QString("SHARES");
        case mSHARES:
            return QString("Milli-SHARES (1 / 1" THIN_SP_UTF8 "000)");
        case uSHARES:
            return QString("Micro-SHARES (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case SHARES:
            return QString("TestSHARESs");
        case mSHARES:
            return QString("Milli-TestSHARES (1 / 1" THIN_SP_UTF8 "000)");
        case uSHARES:
            return QString("Micro-TestSHARES (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
