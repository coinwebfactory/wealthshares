...
/** Utility functions used by the WealthShares Qt UI.
 */
namespace GUIUtil
{
...
// Render SHARES addresses in monospace font
...
// Parse "wealthshares:" URI into recipient object, return true on successful parsing
