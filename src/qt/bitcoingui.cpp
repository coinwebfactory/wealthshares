                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("WealthShares Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SHARES address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and wealthshares: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About WealthShares Core"), this);
    aboutAction->setStatusTip(tr("Show information about WealthShares Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for WealthShares"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SHARES addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_black"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SHARES addresses"));
    ...
    openAction->setStatusTip(tr("Open a wealthshares: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the WealthShares Core help message to get a list with possible WealthShares command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("WealthShares Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to WealthShares network", "", count));
}
...
{
    QString strTitle = tr("WealthShares Core"); // default title
