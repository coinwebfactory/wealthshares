...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("WealthShares Core wealthshares-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  wealthshares-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded wealthshares transaction") + "\n" +
                               "  wealthshares-tx [options] -create [commands]   " + _("Create hex-encoded wealthshares transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded wealthshares transaction
