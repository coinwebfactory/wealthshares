...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop WealthShares server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "WealthShares server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* WealthShares features */
        {"wealthshares", "masternode", &masternode, true, true, false},
        {"wealthshares", "listmasternodes", &listmasternodes, true, true, false},
        {"wealthshares", "getmasternodecount", &getmasternodecount, true, true, false},
        {"wealthshares", "masternodeconnect", &masternodeconnect, true, true, false},
        {"wealthshares", "masternodecurrent", &masternodecurrent, true, true, false},
        {"wealthshares", "masternodedebug", &masternodedebug, true, true, false},
        {"wealthshares", "startmasternode", &startmasternode, true, true, false},
        {"wealthshares", "createmasternodekey", &createmasternodekey, true, true, false},
        {"wealthshares", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"wealthshares", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"wealthshares", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"wealthshares", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"wealthshares", "getmasternodescores", &getmasternodescores, true, true, false},
        {"wealthshares", "mnbudget", &mnbudget, true, true, false},
        {"wealthshares", "preparebudget", &preparebudget, true, true, false},
        {"wealthshares", "submitbudget", &submitbudget, true, true, false},
        {"wealthshares", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"wealthshares", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"wealthshares", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"wealthshares", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"wealthshares", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"wealthshares", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"wealthshares", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"wealthshares", "checkbudgets", &checkbudgets, true, true, false},
        {"wealthshares", "mnsync", &mnsync, true, true, false},
        {"wealthshares", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> wealthshares-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:34889/\n";
}
