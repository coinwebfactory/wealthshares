...
#if defined(NDEBUG)
#error "WealthShares cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in ushares) are considered zero fee (for relaying and mining)
...
{
    RenameThread("wealthshares-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // SHARES: We use certain sporks during IBD, so check to see if they are
