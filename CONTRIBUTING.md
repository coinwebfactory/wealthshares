Contributing to WealthShares Core
==================================

The WealthShares Core project operates an open contributor model where anyone is
...
The following applies to code changes to the WealthShares Core project, and is not to be
confused with overall WealthShares Network Protocol consensus changes.

Whether a pull request is merged into WealthShares Core rests with the project merge
...
Patches that change WealthShares consensus rules are considerably more involved than
...
Where a patch set proposes to change the WealthShares consensus, it must have been
...
The project leader is the release manager for each WealthShares Core release.
