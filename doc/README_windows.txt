...
Intro
-----
WealthShares (SHARES) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. WealthShares utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run wealthshares-qt.exe.

WealthShares Core is the original WealthShares client and it builds the backbone of the network.
However, it downloads and stores the entire history of WealthShares transactions;
