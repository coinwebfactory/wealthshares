...
In order to support loading of multiple wallets in wealthshares-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is wealthshares.cpp.
...
Changes to wealthshares.cpp
----------------------
wealthshares.cpp is the entry point into wealthshares-qt, and as such, will require some minor modifications to provide hooks for
