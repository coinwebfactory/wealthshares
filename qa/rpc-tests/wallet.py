...
#   c) node1 mines 32 blocks, so now node 0 has 500000SHARES, node 1 has 4250SHARES, node2 has none.
#   d) node0 sends 601 SHARES to node2, in two transactions (301 SHARES, then 300 SHARES).
